...
public class UserServiceTest {
    ...
    public void shouldInitializeWithTwoDemoUsers() {
        ...
        // assert
        verify(accountRepositoryMock, times(2)).saveAccount(any(Account.class));
    }
    ...
    public void shouldThrowExceptionWhenUserNotFound() {
        ...
        when(accountRepositoryMock.findByEmailOrLogin("user@example.com")).thenReturn(null);
        // act
    ...
    public void shouldReturnUserDetails() {
        ...
        when(accountRepositoryMock.findByEmailOrLogin("user@example.com")).thenReturn(demoUser);
